    ...
    class Program
    {
        ...
        private static void ShuffleArray(int[] nums, int n)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Please enter" + 2 * n + "elements"); /// If the elements are not in 2n form, send back to the user.
                }
                ...
                for (j = 0; j < length; j++)
                {
...

                    {
                        ...
                        if (ar2[i] == 0)/// If element found is 0 in the array
                        {
                            ...
                            // while statement
                            while (i < length - 1)/// iterates through the loop and swapping values till zero value found reaches towards the end of the array.
                            {
                                ar2[i] = ar2[i + 1];
                                i = i + 1;
        ...
        private static void CoolPairs(int[] nums)
        {
            ...
            try
            {
                //declare vairables and create dictiionsry
                int count = 0;
       ...
       //self reflection: It checked, I can use the difference of target and array element. Getting that logic was the challenging part.
        ...
        private static bool Isomorphic(string s1, string s2)
        {
            ...
            try
            {
                //check is if the lengths are not equal they are definitely not isomorphic.
